  ...
  return (
    <footer className="border-t border-border bg-background">
      <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center space-x-3 mb-6">
              ...
              />
              <span className="text-lg font-bold text-foreground tracking-tight">Promptvexity</span>
            </Link>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-foreground text-sm tracking-tight mb-4">Platform</h3>
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/create/problem" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Create Problem
                </Link>
              </li>
            </ul>
          ...
          {/* Community */}
          <div>
            <h3 className="font-semibold text-foreground text-sm tracking-tight mb-4">Resources</h3>
            <ul className="space-y-3">
              <li>
        ...
        <div className="border-t border-border flex flex-col md:flex-row justify-between items-center mt-12 pt-8">
          <p className="text-sm text-muted-foreground">
            &copy; 2026 Promptvexity. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="https://www.linkedin.com/company/marketintegrators" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
              <span className="sr-only">LinkedIn</span>
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
            <span className="text-muted-foreground/40 cursor-not-allowed" title="GitHub (coming soon)">
